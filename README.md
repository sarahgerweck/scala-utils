...
For Java 8, use this line as your dependency:
    ...
    libraryDependencies += "org.gerweck.scala" %% "gerweck-utils" % "3.0.0"

For Java 6 or Java 7, use this line as your dependency:

    libraryDependencies += "org.gerweck.scala" %% "gerweck-utils-java6" % "3.0.0"
...
need these utilities, include this as well.
    ...
    libraryDependencies += "org.gerweck.scala" %% "gerweck-utils-twitter" % "3.0.0"
...
utilities require Java 8 and Akka 2.4.
    ...
    libraryDependencies += "org.gerweck.scala" %% "gerweck-utils-akka" % "3.0.0"
...
separate module. These modules require Java 8 and can be included as such:
    ...
    libraryDependencies += "org.gerweck.scala" %% "gerweck-utils-db" % "3.0.0"
